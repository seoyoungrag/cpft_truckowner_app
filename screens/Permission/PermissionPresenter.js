				...
				<>
					<Data>
						...
						<Container>
							...
							<DataValue>휴대폰 정보 확인통화 회원가입 및 로그인, 법인 담당자 및 관리자 전화연결</DataValue>
						</Container>
						<Container>
						...
						<Container>
							...
							<DataValueRed>
								필수적 접근권한 항목은 서비스의 실행을 위해 반드시 필요하며, 허용하지 않을 경우 서비스의 이용이 제한 됩니다.
							</DataValueRed>
						</Container>
						<Container>
						...
						<Container>
							...
							<DataValue>내 주변 매장 찾기, 운행기록 서비스 이용, 배차현황 서비스 이용</DataValue>
						</Container>
						<Container>
							<DataName>카메라</DataName>
						...
						<Container>
							<DataValueRed>선택적 접근권한은 기능 사용시 허용이 필요하며, 비허용시에도 해당기능 외 서비스 이용이 가능합니다.</DataValueRed>
						</Container>
						<Container>
